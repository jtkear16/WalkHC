/*
Fileaname: MKMapRectRotated.swift
...
/**
    ...
    - returns: MKMapRect constructed from the four corners of a (probably
        rotated) rectangle.
*/
func MKMapRectRotatedMake(corner1: MKMapPoint, corner2: MKMapPoint, corner3: MKMapPoint, corner4: MKMapPoint) -> MKMapRectRotated{
...
*/
func MKMapRectRotatedNearestPoint(mapRectRotated: MKMapRectRotated, point: MKMapPoint) -> MKMapPoint {
