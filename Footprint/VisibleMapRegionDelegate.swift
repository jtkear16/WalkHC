/*
Fileaname: VisibleMapRegionDelegate.swift
...
class VisibleMapRegionDelegate: NSObject {
    ...
    */
    private var boundingMapRectIncludingRotations: MKMapRect
    private var boundingPDFBox: MKMapRectRotated
    private var floorplanCenter: CLLocationCoordinate2D!
    private var floorplanUprightMKMapCameraHeading: CLLocationDirection!
    ...
    */
    func resetCameraOrientation(mapView: MKMapView, center: CLLocationCoordinate2D, heading: CLLocationDirection) {
    ...
    */
    func floorplanDoesNotFillScreen(mapView: MKMapView, floorplanBoundingMapRect: MKMapRect) -> Bool {
    ...
    */
    func getZoomAdjustment(mapView: MKMapView, floorplanBoundingMapRect: MKMapRect) -> Double {
    ...
    */
    func clampZoomToFloorplan(mapView: MKMapView, floorplanBoundingMapRect: MKMapRect, floorplanCenter: CLLocationCoordinate2D) -> Bool {
    ...
    /**
        ...
        - parameter optionalCameraHeading: If you give valid CLLocationDirection
            ...
            camera already has.
    */
    func clampScrollToFloorplan(mapView: MKMapView, floorplanBoundingPDFBoxRect: MKMapRectRotated, optionalCameraHeading: CLLocationDirection) {
        ...
        */
        ...
        let visibleMapRectMidPixels = mapView.convertCoordinate(MKCoordinateForMapPoint(visibleMapRectMid), toPointToView: mapView)
        let visibleMapRectProposedPixels = mapView.convertCoordinate(MKCoordinateForMapPoint(visibleMapRectOriginProposed), toPointToView: mapView)
