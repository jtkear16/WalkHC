...
*/
func smallest(a: Double, b: Double) -> Double {
...
*/
func clamp(val: Double, min: Double, max: Double) -> Double {
...
extension MKMapPoint {
    ...
    */
    static func midpoint(a: MKMapPoint, b: MKMapPoint) -> MKMapPoint {
    ...
    */
    func displacementToPoint(other: MKMapPoint) -> MKMapPointDisplacement {
        let dx = (other.x - x)
        let dy = (other.y - y)
...
extension CLLocationDistance {
    ...
    */
    static func distanceBetweenLocationCoordinates2D(a: CLLocationCoordinate2D, b: CLLocationCoordinate2D) -> CLLocationDistance {
...
extension CGPoint {
    ...
    */
    static func pointAverage(a: CGPoint, b: CGPoint) -> CGPoint {
...
extension CGVector {
    ...
    */
    func dotProductWithVector(other: CGVector) -> CGFloat {
    ...
    */
    func scaledByFloat(scale: CGFloat) -> CGVector {
    ...
    */
    func rotatedByRadians(radians: CGFloat) -> CGVector {
...
extension CGPoint {
    ...
    */
    static func hypotenuse(a: CGPoint, b: CGPoint) -> Double {
